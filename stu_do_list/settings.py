"""
Django settings for stu_do_list project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-u1j6%cbl3-51cv)g3^90q!cx7*f#35x+kt1oe#^wmhiv8-c-c3')
...
WSGI_APPLICATION = 'stu_do_list.wsgi.application'
